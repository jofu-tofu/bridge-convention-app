...
// Engine utilities — display/comparison functions (pure, operate on API contract types)
export { callKey, callsMatch } from "../engine/call-helpers";
export { isVulnerable } from "../engine/scoring";

// ── Convention system re-exports (for UI that needs convention metadata) ──
...
// Teaching types used as fields in TeachingDetail / viewport types
