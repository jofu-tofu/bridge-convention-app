...
| `tokens.ts`            | CSS design tokens: suit color classes (`SUIT_COLOR_CLASS`, `SUIT_CARD_COLOR_CLASS`, `BID_SUIT_COLOR_CLASS`), typography tokens (`TextToken` type, `TEXT_TOKEN_CLASS` map) |
