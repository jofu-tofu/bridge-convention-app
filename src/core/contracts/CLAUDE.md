...
| `tree-evaluation.ts` | `ConditionDetail`, `TreePathEntry`, `TreeForkPoint`, `SiblingConditionDetail`, `SiblingBid`, `CandidateBid`, `CandidateEligibility`, `ResolvedCandidateDTO`, `AlternativeGroup`, `TreeEvalSummary`, `EvaluationTrace`, `isDtoSelectable()` |
