...
| `tree-evaluation.ts` | `ConditionDetail`, `TreePathEntry`, `TreeForkPoint`, `SiblingConditionDetail`, `SiblingBid`, `CandidateBid`, `CandidateEligibility`, `ResolvedCandidateDTO`, `TreeEvalSummary`, `EvaluationTrace`, `isDtoSelectable()` |
