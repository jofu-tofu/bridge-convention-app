...
import type { PedagogicalRelationKind } from "./teaching-projection";
...
export interface PedagogicalTagDef {
  readonly id: string;
 ...
 */
export interface PedagogicalTagRef {
  readonly tag: PedagogicalTagDef;
