...
export { DEFAULT_DRILL_TUNING, DEFAULT_DISPLAY_SETTINGS } from "../core/contracts/drill";
export type { OpponentMode, VulnerabilityDistribution, DrillTuning, DisplaySettings } from "../core/contracts/drill";
