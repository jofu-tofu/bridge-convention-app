...
export const gerberResponder = () => hand(
  "SA", "SK", "S5", "S2",
  "HA", "H3",
  "DK", "D5", "D3",
  "CQ", "C5", "C3", "C2",
...
export const gerberOpener = () => hand(
  "SQ", "SJ", "S3",
  "HK", "HQ", "HJ", "H2",
  "DA", "D7", "D4",
  "CA", "C7", "C4",
...
export const bergenOpener = () => hand(
  "SK", "S5", "S2",
  "HA", "HK", "HQ", "H7", "H3",
  "D5", "D3",
  "C5", "C3", "C2",
...
export const bergenResponder = () => hand(
  "SQ", "S5", "S2",
  "HJ", "HT", "H6", "H2",
  "DK", "D7", "D3",
  "C5", "C3", "C2",
...
export const dontOvercaller = () => hand(
  "S5", "S3", "S2",
  "HA", "HK", "HQ", "HJ", "H7", "H3",
  "D5", "D2",
  "C5", "C2",
...
export const dontOpponent = () => hand(
  "SA", "SK", "S4",
  "HT", "H5", "H2",
  "DA", "DK", "D6", "D3",
  "CQ", "CJ", "C4",
