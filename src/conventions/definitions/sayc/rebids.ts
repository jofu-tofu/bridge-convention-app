...
export function makeOpenerNonRaiseRebidBranch(): HandNode {
  return handDecision(
    ...
    saycBid("sayc-rebid-raise-partner-major", "Raises partner's major suit response",
      { type: SemanticIntentType.ShowSupport, params: { level: 2 } },
      rebidRaisePartnerMajorCall),
    handDecision(
      "rebid-own-suit",
      and(hcpRange(12, 17), sixPlusInOpenedSuit()),
      saycBid("sayc-rebid-own-suit", "Rebids showing a 6+ card suit",
        { type: SemanticIntentType.NaturalBid, params: {} },
        rebidOwnSuitCall),
      handDecision(
        "rebid-1nt",
        and(hcpRange(12, 14), isBalanced()),
        saycBid("sayc-rebid-1nt", "Rebids notrump showing a balanced hand",
        ...
        handDecision(
          ...
          saycBid("sayc-rebid-2nt", "Rebids notrump showing extra values",
...
export function makeOpenerRebidBranch(): HandNode {
  return handDecision(
    ...
    saycBid("sayc-rebid-4m-after-raise", "Jumps to game in the raised major",
      { type: SemanticIntentType.ForceGame, params: {} },
      rebid4mAfterRaiseCall),
    handDecision(
      "rebid-3m-invite",
      and(hcpRange(17, 18), partnerRaisedOurMajor()),
      saycBid("sayc-rebid-3m-invite", "Invites game in the raised major",
        { type: SemanticIntentType.InviteGame, params: {} },
        rebid3mInviteCall),
      handDecision(
        "rebid-pass-raise",
        and(hcpRange(12, 16), partnerRaisedOurMajor()),
        saycBid("sayc-rebid-pass-after-raise", "Accepts partner's raise",
...
export function makeOpenerTransferOrRebid(): RuleNode {
  ...
  return decision(
    ...
    saycBid("sayc-opener-accept-transfer", "Completes the Jacoby transfer",
