...
export const SAME_FAMILY: TeachingTagDef = {
  id: "same-family",
...
export const STRONGER_THAN: TeachingTagDef = {
  id: "stronger-than",
...
export const CONTINUATION_OF: TeachingTagDef = {
  id: "continuation-of",
...
export const NEAR_MISS_OF: TeachingTagDef = {
  id: "near-miss-of",
...
export const FALLBACK_OF: TeachingTagDef = {
  id: "fallback-of",
...
export const ALTERNATIVES: TeachingTagDef = {
  id: "alternatives",
...
export const ALL_PEDAGOGICAL_TAGS: readonly TeachingTagDef[] = [
  SAME_FAMILY,
  STRONGER_THAN,
  CONTINUATION_OF,
  NEAR_MISS_OF,
