...
const MEANING_EXPLANATIONS: Record<BergenMeaningId, MeaningExplanationEntry> = {
  ...
  [BERGEN_MEANING_IDS.OPENER_GAME_TRY_AFTER_CONSTRUCTIVE_HEARTS]: {
    explanationId: "bergen.r2.gameTryAfterConstructiveHearts",
    meaningId: BERGEN_MEANING_IDS.OPENER_GAME_TRY_AFTER_CONSTRUCTIVE_HEARTS,
    templateKey: "bergen.r2.gameTryAfterConstructiveHearts.semantic",
    displayText: "Opener makes a game try with 3\u2666 after constructive raise (14-16 HCP)",
    preferredLevel: "semantic",
    roles: ["pedagogical"],
  },
  ...
  [BERGEN_MEANING_IDS.OPENER_GAME_TRY_AFTER_CONSTRUCTIVE_SPADES]: {
    explanationId: "bergen.r2.gameTryAfterConstructiveSpades",
    meaningId: BERGEN_MEANING_IDS.OPENER_GAME_TRY_AFTER_CONSTRUCTIVE_SPADES,
    templateKey: "bergen.r2.gameTryAfterConstructiveSpades.semantic",
    displayText: "Opener makes a game try with 3\u2665 after constructive raise (14-16 HCP)",
    preferredLevel: "semantic",
    roles: ["pedagogical"],
  },
