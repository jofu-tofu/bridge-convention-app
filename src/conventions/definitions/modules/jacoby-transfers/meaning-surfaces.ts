...
export const OPENER_TRANSFER_HEARTS_SURFACES: readonly BidMeaning[] = [
  createSurface({
    ...
    declarationOrder: 0,
    sourceIntent: { type: "AcceptTransfer", params: { suit: ObsSuit.Hearts } },
...
export const OPENER_TRANSFER_SPADES_SURFACES: readonly BidMeaning[] = [
  createSurface({
    ...
    band: RecommendationBand.Must,
    declarationOrder: 0,
    sourceIntent: { type: "AcceptTransfer", params: { suit: ObsSuit.Spades } },
    disclosure: Disclosure.Standard,
...
export function createTransferR3HeartsSurfaces(_sys: SystemConfig): readonly BidMeaning[] {
  ...
  createSurface({
    ...
    band: RecommendationBand.Must,
    declarationOrder: 0,
    sourceIntent: { type: "Signoff", params: { suit: ObsSuit.Hearts } },
  ...
  createSurface({
    ...
    band: RecommendationBand.Must,
    declarationOrder: 1,
    sourceIntent: { type: "GameInMajor", params: { suit: ObsSuit.Hearts } },
  ...
  createSurface({
    ...
    band: RecommendationBand.Must,
    declarationOrder: 2,
    sourceIntent: { type: "TransferNTGame", params: { suit: ObsSuit.Hearts } },
    disclosure: Disclosure.Alert,
  ...
  createSurface({
    ...
    band: RecommendationBand.Should,
    declarationOrder: 3,
    sourceIntent: { type: "InviteRaise", params: { suit: ObsSuit.Hearts } },
    disclosure: Disclosure.Alert,
  ...
  createSurface({
    ...
    band: RecommendationBand.Should,
    declarationOrder: 4,
    sourceIntent: { type: "Invite", params: { suit: ObsSuit.Hearts } },
    disclosure: Disclosure.Alert,
  ...
  createSurface({
    ...
    band: RecommendationBand.Should,
    declarationOrder: 5,
    sourceIntent: { type: "InviteMajorMajor", params: { suit: ObsSuit.Spades } },
    disclosure: Disclosure.Alert,
  ...
  createSurface({
    ...
    band: RecommendationBand.Should,
    declarationOrder: 6,
    sourceIntent: { type: "NewSuitGameForce", params: { suit: ObsSuit.Clubs } },
    disclosure: Disclosure.Alert,
  ...
  createSurface({
    ...
    band: RecommendationBand.Should,
    declarationOrder: 7,
    sourceIntent: { type: "NewSuitGameForce", params: { suit: ObsSuit.Diamonds } },
    disclosure: Disclosure.Alert,
  ...
  createSurface({
    ...
    band: RecommendationBand.Should,
    declarationOrder: 8,
    sourceIntent: { type: "ShortageSlamTry", params: { suit: ObsSuit.Spades } },
    disclosure: Disclosure.Alert,
  ...
  createSurface({
    ...
    band: RecommendationBand.Must,
    declarationOrder: 9,
    sourceIntent: { type: "QuantitativeSlam", params: { suit: ObsSuit.Hearts } },
    disclosure: Disclosure.Alert,
...
export function createTransferR3SpadesSurfaces(_sys: SystemConfig): readonly BidMeaning[] {
  ...
  createSurface({
    ...
    band: RecommendationBand.Must,
    declarationOrder: 0,
    sourceIntent: { type: "Signoff", params: { suit: ObsSuit.Spades } },
    disclosure: Disclosure.Natural,
  ...
  createSurface({
    ...
    band: RecommendationBand.Must,
    declarationOrder: 1,
    sourceIntent: { type: "GameInMajor", params: { suit: ObsSuit.Spades } },
    disclosure: Disclosure.Alert,
  ...
  createSurface({
    ...
    band: RecommendationBand.Must,
    declarationOrder: 2,
    sourceIntent: { type: "TransferNTGame", params: { suit: ObsSuit.Spades } },
    disclosure: Disclosure.Alert,
  ...
  createSurface({
    ...
    band: RecommendationBand.Should,
    declarationOrder: 3,
    sourceIntent: { type: "InviteRaise", params: { suit: ObsSuit.Spades } },
    disclosure: Disclosure.Alert,
  ...
  createSurface({
    ...
    band: RecommendationBand.Should,
    declarationOrder: 4,
    sourceIntent: { type: "Invite", params: { suit: ObsSuit.Spades } },
    disclosure: Disclosure.Alert,
  ...
  createSurface({
    ...
    band: RecommendationBand.Should,
    declarationOrder: 7,
    sourceIntent: { type: "SlamTrySecondMajor", params: { suit: ObsSuit.Hearts } },
    disclosure: Disclosure.Alert,
  ...
  createSurface({
    ...
    band: RecommendationBand.Should,
    declarationOrder: 8,
    sourceIntent: { type: "GameInOtherMajor", params: { suit: ObsSuit.Hearts } },
    disclosure: Disclosure.Alert,
  ...
  createSurface({
    ...
    band: RecommendationBand.Must,
    declarationOrder: 9,
    sourceIntent: { type: "QuantitativeSlam", params: { suit: ObsSuit.Spades } },
    disclosure: Disclosure.Alert,
...
export const OPENER_PLACE_HEARTS_SURFACES: readonly BidMeaning[] = [
  createSurface({
    ...
    band: RecommendationBand.Must,
    declarationOrder: 0,
    sourceIntent: { type: "PlacementCorrection", params: { suit: ObsSuit.Hearts } },
    disclosure: Disclosure.Alert,
  ...
  createSurface({
    ...
    band: RecommendationBand.Must,
    declarationOrder: 1,
    sourceIntent: { type: "PlacementPass", params: { suit: ObsSuit.Hearts } },
    disclosure: Disclosure.Alert,
...
export const OPENER_PLACE_SPADES_SURFACES: readonly BidMeaning[] = [
  createSurface({
    ...
    band: RecommendationBand.Must,
    declarationOrder: 0,
    sourceIntent: { type: "PlacementCorrection", params: { suit: ObsSuit.Spades } },
    disclosure: Disclosure.Alert,
  ...
  createSurface({
    ...
    band: RecommendationBand.Must,
    declarationOrder: 1,
    sourceIntent: { type: "PlacementPass", params: { suit: ObsSuit.Spades } },
    disclosure: Disclosure.Alert,
...
export function createOpenerAcceptInviteHeartsSurfaces(_sys: SystemConfig): readonly BidMeaning[] {
  ...
  createSurface({
    ...
    band: RecommendationBand.Should,
    declarationOrder: 0,
    sourceIntent: { type: "AcceptInvite", params: { suit: ObsSuit.Hearts } },
    disclosure: Disclosure.Alert,
  ...
  createSurface({
    ...
    band: RecommendationBand.Should,
    declarationOrder: 1,
    sourceIntent: { type: "SignoffWithFit", params: { suit: ObsSuit.Hearts } },
    disclosure: Disclosure.Alert,
...
export function createOpenerAcceptInviteSpadesSurfaces(_sys: SystemConfig): readonly BidMeaning[] {
  ...
  createSurface({
    ...
    band: RecommendationBand.Should,
    declarationOrder: 0,
    sourceIntent: { type: "AcceptInvite", params: { suit: ObsSuit.Spades } },
    disclosure: Disclosure.Alert,
  ...
  createSurface({
    ...
    band: RecommendationBand.Should,
    declarationOrder: 2,
    sourceIntent: { type: "SignoffWithFit", params: { suit: ObsSuit.Spades } },
    disclosure: Disclosure.Alert,
