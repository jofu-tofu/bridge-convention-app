...
const MEANING_EXPLANATIONS: Record<BlackwoodMeaningId, MeaningExplanationEntry> = {
  ...
  [BLACKWOOD_MEANING_IDS.RESPONSE_4_ACES]: {
    explanationId: "blackwood.response4Aces",
    meaningId: BLACKWOOD_MEANING_IDS.RESPONSE_4_ACES,
    templateKey: "blackwood.response4Aces.semantic",
    displayText: "5♣ shows 0 (or 4) aces",
    preferredLevel: "semantic",
    roles: ["pedagogical"],
  },
  ...
  [BLACKWOOD_MEANING_IDS.KING_RESPONSE_0]: {
    ...
    displayText: "6♣ shows 0 (or 4) kings",
    preferredLevel: "semantic",
    roles: ["pedagogical"],
  },
  [BLACKWOOD_MEANING_IDS.KING_RESPONSE_4]: {
    explanationId: "blackwood.kingResponse4",
    meaningId: BLACKWOOD_MEANING_IDS.KING_RESPONSE_4,
    templateKey: "blackwood.kingResponse4.semantic",
    displayText: "6♣ shows 0 (or 4) kings",
    preferredLevel: "semantic",
    roles: ["pedagogical"],
  },
