/**
 * Jacoby Transfers — rule definitions for rule-based surface selection.
 *
...
import type { Claim } from "../../core/rule-module";
import {
...
export const jacobyTransfersLocal: LocalFsm<Phase> = {
  initial: "idle",
  transitions: [
...
export const jacobyTransfersRuleDefs: readonly Rule<Phase>[] = [
