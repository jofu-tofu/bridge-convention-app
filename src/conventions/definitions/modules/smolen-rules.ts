/**
 * Smolen — rule definitions for rule-based surface selection.
 *
...
import type { LocalFsm, Rule, Claim } from "../../core/rule-module";
...
export const smolenLocal: LocalFsm<Phase> = {
  initial: "idle",
  transitions: [
...
export const smolenRuleDefs: readonly Rule<Phase>[] = [
  ...
  // Per-surface deltas: 3H → spade fit, 3S → heart fit (bid shows SHORT major)
  {
    ...
    claims: smolenR3Surfaces.map((s): Claim => ({
      surface: s,
