...
const MEANING_EXPLANATIONS: Record<SmolenMeaningId, MeaningExplanationEntry> = {
  ...
  [SMOLEN_MEANING_IDS.PLACE_FOUR_SPADES]: {
    explanationId: "nt.smolen.placeFourSpades",
    meaningId: SMOLEN_MEANING_IDS.PLACE_FOUR_SPADES,
    templateKey: "nt.smolen.placeFourSpades.semantic",
    displayText: "Place 4\u2660: opener confirms spade fit after Smolen 3\u2665",
    preferredLevel: "semantic",
    roles: ["pedagogical"],
  },
