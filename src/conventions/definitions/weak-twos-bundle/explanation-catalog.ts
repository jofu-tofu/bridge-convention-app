...
const WEAK_TWO_ENTRIES: ExplanationEntry[] = [
...

  {
    ...
    displayText: "5-11 HCP for a weak two opening",
    contrastiveTemplateKey: "weakTwo.hcp.opener.whyNot",
    contrastiveDisplayText: "HCP not in weak two range (5-11)",
...

  {
    ...
    displayText: "Minimum hand (5-8 HCP) for Ogust",
...

  {
    ...
    displayText: "Open 2H: 6+ hearts, 5-11 HCP",
    preferredLevel: "semantic",
    roles: ["pedagogical"],
  },
  {
    ...
    displayText: "Open 2S: 6+ spades, 5-11 HCP",
    preferredLevel: "semantic",
    roles: ["pedagogical"],
  },
  {
    ...
    displayText: "Open 2D: 6+ diamonds, 5-11 HCP",
    preferredLevel: "semantic",
    roles: ["pedagogical"],
  },
