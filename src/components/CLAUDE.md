...
components/
  screens/
    ...
    WorkshopScreen.svelte            System/convention/practice pack management — three-tab toggle (Systems, Conventions, Practice Packs). The Practice Packs tab is a temporary adapter over multi-module entries in the unified `drillsStore`. Hosts SystemEditor inline.
    ...
    PracticePackEditorScreen.svelte  Practice pack builder — name/description + convention selection via ModuleChecklist with reorder. Supports create blank, fork from bundle, and edit modes. Phase A adapter saves multi-module entries into the unified `drillsStore`.
...
<!-- context-layer: generated=2026-02-21 | last-audited=2026-04-18 | version=24 | dir-commits-at-audit=20 | tree-sig=dirs:11,files:60+,exts:svelte:45,ts:20+,md:1 -->
