...
| --------------------------- | --------------- | ------------------------------------------ | ---------------- |
| `bergen-splinter`           | 3-other-major   | After 1M-P, 12+ HCP, 4+ support, shortage | bridgebum/bergen |
...
| `bergen-constructive-raise` | 3C              | After 1M-P, 7-10 HCP, 4+ support          | bridgebum/bergen |
