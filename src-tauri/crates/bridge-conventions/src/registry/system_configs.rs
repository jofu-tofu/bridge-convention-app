...
pub fn acol_system_config() -> SystemConfig {
    SystemConfig {
        ...
        responder_thresholds: ResponderThresholds {
            ...
            game_min: 13,
            slam_min: 19,
            invite_min_tp: TotalPointEquivalent { trump: 10, nt: 10 },
            invite_max_tp: TotalPointEquivalent { trump: 13, nt: 12 },
            game_min_tp: TotalPointEquivalent { trump: 13, nt: 13 },
            slam_min_tp: TotalPointEquivalent { trump: 20, nt: 19 },
        },
        opener_rebid: OpenerRebidThresholds {
            not_minimum: 13,
            not_minimum_tp: TotalPointEquivalent { trump: 13, nt: 13 },
        },
